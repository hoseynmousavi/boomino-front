...
function SocialIcons()
{
    return (
        <>
            <a className="footer-top-right-social-svg-link" href="https://www.twitter.com/MCI_Boomino" target="_blank" rel="noreferrer"><TwitterSvg className="footer-top-right-social-svg"/></a>
